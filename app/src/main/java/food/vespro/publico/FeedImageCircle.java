...
public class FeedImageCircle extends NetworkImageView {
    ...
    public FeedImageCircle(Context context) {
        super(context);
        init();
    }

    public FeedImageCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FeedImageCircle(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, de.hdodenhof.circleimageview.R.styleable.CircleImageView, defStyle, 0);
